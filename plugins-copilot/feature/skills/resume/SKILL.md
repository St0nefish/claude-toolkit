...
name: resume
description: >-
  Resume work on an existing in-progress branch. Lists active branches,
  checks out the selected one, and rebuilds full work context including
  linked issue, WIP commit notes, and suggested next steps.
