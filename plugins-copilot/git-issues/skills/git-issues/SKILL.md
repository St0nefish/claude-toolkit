...
```
${COPILOT_PLUGIN_ROOT}/scripts/git-issues <cmd> [args]
```
...
```bash
${COPILOT_PLUGIN_ROOT}/scripts/git-issues list --limit 50
```
...
```bash
${COPILOT_PLUGIN_ROOT}/scripts/git-issues show <number>
```
...
```bash
${COPILOT_PLUGIN_ROOT}/scripts/git-issues pr \
  --title "<issue title>" \
