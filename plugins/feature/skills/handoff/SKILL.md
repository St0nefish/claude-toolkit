...
name: handoff
description: >-
  Commit all work, push, and record handoff context on the linked issue
  for cross-machine pickup. Creates a WIP commit with in-progress notes
  and posts next steps to the issue tracker.
