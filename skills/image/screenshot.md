...
Execute `~/.claude/tools/image/bin/screenshot` to find the most recent screenshot. The script outputs the path to the newest `.png` file. Read that image file and display it to the user. Be concise.
